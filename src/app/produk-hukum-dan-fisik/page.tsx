...
import { produkHukumData } from "@/features/produk-hukum-dan-fisik/data";
import { pembangunanData } from "@/features/produk-hukum-dan-fisik/data";
        ...
        <div className="max-w-6xl  flex flex-col md:flex-row gap-0  ">
          ...
          <div className="md:w-1/2 flex items-center ">
            ...
            >
              ...
              masyarakat, untuk mendorong partisipasi aktif warga dalam
              pengambilan keputusan serta memastikan setiap tahapan pembangunan
              berjalan sesuai rencana dan kebutuhan bersama.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex gap-4 mb-8">
            ...
            >
              ...
              >
                <path
                  d="M133.202,84.142c5.795,0,10.493,4.698,10.493,10.493s-4.698,10.493-10.493,10.493s-10.493-4.698-10.493-10.493
              ...
              {hukumItems.map((item, idx) => (
                ...
                >
                  <div className="flex flex-col items-center gap-2 min-w-[60px]">
                    ...
                    <Image
                      src={item.fileType === "pdf" ? "/file.svg" : "/file.svg"}
                      alt="filetype"
                      width={32}
                      height={32}
                    />

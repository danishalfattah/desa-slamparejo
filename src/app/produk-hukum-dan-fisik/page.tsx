...
async function getProdukData() {
  try {
    ...
    if (!hukumRes.ok || !pembangunanRes.ok || !pageRes.ok) {
    ...
    return { produkHukumData: [], pembangunanData: [], pageData: {} };
  }
}
...
export default async function ProdukPage() {
  const { produkHukumData, pembangunanData, pageData } = await getProdukData();
